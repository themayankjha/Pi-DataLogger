...
def histoplotter():
        ...
        plot.title("Sensor Data")
        plot.savefig('sensordata.png')
        content_list.clear()
        os.replace("sensordata.png", time.strftime("%Y%m%d.png"))
        os.replace(time.strftime("%Y%m%d.png"), "static/sensor/"+time.strftime("%Y%m%d.png"))
        return time.strftime("%Y%m%d.png")
